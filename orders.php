...
<ol class="breadcrumb">
  <li><a href="dashboard.php">হোমে পেজ</a></li>
  <li>অর্ডার</li>
  <li class="active">
  	<?php if($_GET['o'] == 'add') { ?>
  		Add Order
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i>	অর্ডার যোগ করুন
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> অর্ডার পরিচালনা করুন
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> অর্ডার এডিট করুন
		<?php } ?>
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">অর্ডার তারিখ</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="orderDate" name="orderDate" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">কাস্টমারের নাম</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="কাস্টমারের না" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">ফোন</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="ফোন" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:20%;">রেট</th>
			  			<th style="width:10%;">পরিমাণ মজুদ আছে</th>
			  			<th style="width:15%;">পরিমাণ</th>
			  			<th style="width:25%;">মোট</th>
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">সাব পরিমাণ</label>
				    <div class="col-sm-9">
				   ...
				   <!--/form-group-->			  
				  <div class="form-group">
				    <label for="totalAmount" class="col-sm-3 control-label">মোট টাকা</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label">মোট</label>
				    <div class="col-sm-9">
...
<!--				  </div>-->
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="paid" class="col-sm-3 control-label">দেওয়া হয়েছে</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label">বাকি আছে</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">প্রদানের ধরণ</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentType" id="paymentType">
				      	<option value="">~~নির্বাচন করুন~~</option>
				      	<option value="1">চেক</option>
				      	<option value="2">টাকা</option>
				      	<option value="3">ক্রেডিট কার্ড</option>
				      </select>
				    </div>
				  </div> <!--/form-group-->							  
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">প্রদানের অবস্থা</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentStatus" id="paymentStatus">
				      	<option value="">~~নির্বাচন করুণ~~</option>
				      	<option value="1">পুরো</option>
				      	<option value="2">অগ্রিম</option>
				      	<option value="3">হইনি</option>
				      </select>
				    </div>
				  </div> <!--/form-group-->
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">প্রদানের স্থান</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentPlace" id="paymentPlace">
                          ...
                          <option value="6">চট্টগ্রাম</option>
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> যোগ করুণ </button>

			      <button type="submit" id="createOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> সেভ করুণ</button>

			      <button type="reset" class="btn btn-default" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> রিসেট</button>
			    </div>
			  </div>
			</form>
		<?php } else if($_GET['o'] == 'manord') { 
			...
			<table class="table" id="manageOrderTable">
				<thead>
					<tr>
						...
						<th>মক্কেলের নাম</th>
						<th>ফোন নাম্বার</th>
						<th>মোট অর্ডার আইটেম</th>
						<th>প্রদানের অবস্তা</th>
						<th>অপশন</th>
					</tr>
				</thead>
			</table>
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">অর্ডারের তারিখ</label>
			    <div class="col-sm-10">
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">কাস্টমারের নাম</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="কাস্টমারের নাম" autocomplete="off" value="<?php echo $data[2] ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">ফোন</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="ফোন" autocomplete="off" value="<?php echo $data[3] ?>" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			<th style="width:40%;">পণ্য</th>
			  			<th style="width:20%;">রেট</th>
			  			<th style="width:15%;">পণ্য মজুদ আছে</th>
			  			<th style="width:15%;">পরিমাণ</th>
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label">বাকি রয়েছে</label>
				    <div class="col-sm-9">
			  ...
			  <div class="form-group editButtonFooter">
			    <div class="col-sm-offset-2 col-sm-10">
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> পণ্যের জন্য লাইন যোগ করুন </button>

			    <input type="hidden" name="orderId" id="orderId" value="<?php echo $_GET['i']; ?>" />

			    <button type="submit" id="editOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> সেভ করুন</button>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="glyphicon glyphicon-edit"></i> প্রদান এডিট করুণ</h4>
      </div>      
      ...
      <div class="modal-body form-horizontal" style="max-height:500px; overflow:auto;" >
      	...
      	<div class="paymentOrderMessages"></div>
			  ...
			  <div class="form-group">
			    <label for="payAmount" class="col-sm-3 control-label">দেওয়া হয়েছে</label>
			    <div class="col-sm-9">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="updatePaymentOrderBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> সেভ করুণ</button>
      </div>           
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeOrderModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> অর্ডার মুছে ফেলুন</h4>
      </div>
      <div class="modal-body">

      	<div class="removeOrderMessages"></div>

        <p>আপনি নিশ্চিতভাবে মুছতে চান ?</p>
      </div>
      <div class="modal-footer removeProductFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> বন্ধ</button>
        <button type="button" class="btn btn-primary" id="removeOrderBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> মুছে ফেলুন</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
